import usermodel from "../models/User.js"
 const create=async(req,res)=>{
  try {
      const {stt,ma,giahientai,giangungmua,giacannhacba,cotuc,suatcotuc,tangtruonglnkyvong,muctangtruongtonghangnam,ghichu}=req.body
   const Newuser=  new usermodel({
    stt,ma,giahientai,giangungmua,giacannhacba,cotuc,suatcotuc,tangtruonglnkyvong,muctangtruongtonghangnam,ghichu
   })
   await Newuser.save()
